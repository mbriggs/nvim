-- not using this at least until go reporter stops screwing up
return {
    ...
    --     { "<leader>twa", [[<cmd>lua require("neotest").watch.toggle(vim.fn.getcwd())<cr>]],                                     desc = "Toggle watching all tests" },
